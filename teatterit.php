...
<br> <?php
      $googleMapsLink = "https://shorturl.at/ceqmf";
      echo "<a href=\"$googleMapsLink\" target=\"_blank\">Katso sijaintimme Google Mapsista</a>";
    ?>
 


   <br><br></b><b>City Lights Theater Rovaniemi:</b><br>
   ...
   <br><?php
      $googleMapsLink = "https://shorturl.at/d9zwV";
      echo "<a href=\"$googleMapsLink\" target=\"_blank\">Katso sijaintimme Google Mapsista</a>";
    ?>


   <br><br><b>Family Fun Flicks Tampere:</b><br>
  Kutsuva ja värikäs ympäristö, jossa on leikkisä tunnelma, mukavat ja tilavat istuimet 75 henkilölle.
   ...
   <br><?php
      $googleMapsLink = "https://shorturl.at/6SsJ8";
      echo "<a href=\"$googleMapsLink\" target=\"_blank\">Katso sijaintimme Google Mapsista</a>";
    ?>
   <br><br><b>Classic Cinema Palace Helsinki:</b><br>
...
Ravintola kioskista perinteisiä elokuvaherkkuja, kuten popcorneja, virvoitusjuomia ja jäätelöä, sekä hienostuneita vaihtoehtoja, kuten juustolautasia ja samppanjaa.
 <br><?php
      ...
      echo "<a href=\"$googleMapsLink\" target=\"_blank\">Katso sijaintimme Google Mapsista</a>";
    ?>
   <br><br><b>Tech Hub Theaters Turku:</b><br>
   Futuristinen ja moderni ympäristö, jossa korostetaan teknologiaa ja innovaatiota, ergonomiset istuimet 150 henkilölle ja huipputekninen ääni- ja kuvajärjestelmä.
   Ravintolasta mordernit maistuvat annokset, gourmet-vaihtoehtoja sekä innotiiviset drinkki ja viinivalikoimat. Kioskista futuristisien herkkujen lisäksi perinteisiä elokuvaherkkuja.
   <br><?php
      $googleMapsLink = "https://shorturl.at/srj9A";
      echo "<a href=\"$googleMapsLink\" target=\"_blank\">Katso sijaintimme Google Mapsista</a>";
    ?>
</p>
</body></html>
